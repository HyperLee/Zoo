...
- **FR-014**: 系統必須支援使用者自訂路線功能，自動規劃最佳路徑
- **FR-015**: 系統必須支援路線的儲存與網址分享功能

#### 搜尋與篩選

- **FR-016**: 系統必須提供關鍵字搜尋功能，支援中文名稱、英文名稱及學名
- **FR-017**: 系統必須在搜尋輸入時提供即時建議
...
- **FR-027**: 每種動物必須至少有 3 張不同姿態的 AI 生成動物森友會風格插畫
